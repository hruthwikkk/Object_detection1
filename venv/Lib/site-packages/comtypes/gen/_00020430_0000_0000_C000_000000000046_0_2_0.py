...
IFontDisp = Font
__all__ = [ 'OLE_CANCELBOOL', 'FONTITALIC', 'OLE_XSIZE_CONTAINER',
           'FONTBOLD', 'FONTUNDERSCORE', 'OLE_YSIZE_HIMETRIC',
           'StdFont', 'OLE_HANDLE', 'OLE_XPOS_CONTAINER', 'OLE_COLOR',
           'OLE_YPOS_PIXELS', 'Unchecked', 'Color',
           'OLE_YPOS_CONTAINER', 'OLE_YPOS_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'OLE_OPTEXCLUSIVE',
           'LoadPictureConstants', 'OLE_XPOS_PIXELS',
           'FONTSTRIKETHROUGH', 'IPicture', 'IFontEventsDisp',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_PIXELS',
           'OLE_TRISTATE', 'Monochrome', 'IFontDisp', 'FONTSIZE',
           'OLE_XPOS_HIMETRIC', 'StdPicture', 'FontEvents',
           'OLE_YSIZE_PIXELS', 'IPictureDisp', 'OLE_XSIZE_HIMETRIC',
           'Checked', 'IFont', 'Picture', 'Gray', 'FONTNAME',
           'Default', 'VgaColor', 'Font']
